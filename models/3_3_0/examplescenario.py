...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/ExampleScenario) on 2018-05-12.
...
class ExampleScenarioProcessStep(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        Type `ExampleScenarioProcessStepAlternative` (represented as `dict` in JSON). """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("alternative", "alternative", ExampleScenarioProcessStepAlternative, False, None, False),
...
class ExampleScenarioProcessStepAlternative(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        List of `ExampleScenarioProcessStepAlternativeOption` items (represented as `dict` in JSON). """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("name", "name", str, False, None, False),
            ("option", "option", ExampleScenarioProcessStepAlternativeOption, True, None, True),
        ])
        return js


class ExampleScenarioProcessStepAlternativeOption(backboneelement.BackboneElement):
    """ Each of the possible options in an alternative.
    """
    
    resource_type = "ExampleScenarioProcessStepAlternativeOption"
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ExampleScenarioProcessStepAlternativeOption, self).__init__(jsondict=jsondict, strict=strict)
    
    def elementProperties(self):
        js = super(ExampleScenarioProcessStepAlternativeOption, self).elementProperties()
        js.extend([
            ("description", "description", str, False, None, True),
            ("pause", "pause", bool, True, None, False),
            ("step", "step", ExampleScenarioProcessStep, True, None, False),
        ])
        return js
