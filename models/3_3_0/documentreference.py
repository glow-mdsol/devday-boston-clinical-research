...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/DocumentReference) on 2018-05-12.
...
class DocumentReference(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.agent = None
        """ Agent involved.
        List of `DocumentReferenceAgent` items (represented as `dict` in JSON). """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("agent", "agent", DocumentReferenceAgent, True, None, False),
...
class DocumentReferenceAgent(backboneelement.BackboneElement):
    """ Agent involved.
    
    An actor taking an active role in the document.
    """
    
    resource_type = "DocumentReferenceAgent"
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(DocumentReferenceAgent, self).__init__(jsondict=jsondict, strict=strict)
    
    def elementProperties(self):
        js = super(DocumentReferenceAgent, self).elementProperties()
        js.extend([
            ("type", "type", codeableconcept.CodeableConcept, False, None, False),
