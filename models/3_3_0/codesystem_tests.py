...
class CodeSystemTests(unittest.TestCase):
    ...
    def implCodeSystem3(self, inst):
        ...
        self.assertEqual(inst.content, "complete")
        self.assertEqual(inst.date.date, FHIRDate("2018-04-03T12:05:46+10:00").date)
        self.assertEqual(inst.date.as_json(), "2018-04-03T12:05:46+10:00")
        ...
        self.assertEqual(inst.extension[1].url, "http://hl7.org/fhir/StructureDefinition/structuredefinition-ballot-status")
        self.assertEqual(inst.extension[1].valueString, "Draft")
        ...
        self.assertEqual(inst.identifier.value, "urn:oid:2.16.840.1.113883.4.642.1.859")
        self.assertEqual(inst.meta.lastUpdated.date, FHIRDate("2018-04-03T12:05:46.262+10:00").date)
        self.assertEqual(inst.meta.lastUpdated.as_json(), "2018-04-03T12:05:46.262+10:00")
        ...
        self.assertEqual(inst.version, "3.3.0")
    ...
    def implCodeSystem4(self, inst):
        ...
        self.assertEqual(inst.identifier.system, "urn:ietf:rfc:3986")
        self.assertEqual(inst.identifier.value, "urn:oid:2.16.840.1.113883.4.642.1.317")
        self.assertEqual(inst.meta.lastUpdated.date, FHIRDate("2018-04-03T12:05:46.262+10:00").date)
        self.assertEqual(inst.meta.lastUpdated.as_json(), "2018-04-03T12:05:46.262+10:00")
        self.assertEqual(inst.meta.profile[0], "http://hl7.org/fhir/StructureDefinition/shareablecodesystem")
