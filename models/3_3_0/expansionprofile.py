...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/ExpansionProfile) on 2018-05-12.
...
class ExpansionProfile(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ Controls behavior of the value set expand operation when value sets
        ...
        self.url = None
        """ Canonical identifier for this expansion profile, represented as a
        URI (globally unique).
        Type `str`. """
