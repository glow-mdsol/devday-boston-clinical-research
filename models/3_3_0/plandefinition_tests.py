...
class PlanDefinitionTests(unittest.TestCase):
    ...
    def implPlanDefinition1(self, inst):
        self.assertEqual(inst.action[0].action[0].action[0].definition, "#referralToCardiologyConsult")
        ...
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[1].expression, "Code '261QM0850X' from CardiologyChestPainLogic.\"NUCC Provider Taxonomy\" display 'Adult Mental Health'")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[1].path, "specialty")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[2].expression, "CardiologyChestPainLogic.ServiceRequestFulfillmentTime")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[2].path, "occurrenceDateTime")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[3].expression, "CardiologyChestPainLogic.Patient")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[3].path, "subject")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[4].expression, "CardiologyChestPainLogic.Practitioner")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[4].path, "requester.agent")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[5].expression, "CardiologyChestPainLogic.CardiologyReferralReason")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[5].path, "reasonCode")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[6].expression, "CardiologyChestPainLogic.RiskAssessment")
        ...
        self.assertEqual(inst.action[0].action[0].action[1].definition, "#CollectReferralReason")
        self.assertEqual(inst.action[0].action[0].action[1].title, "Reason for cardiology consultation")
        self.assertEqual(inst.action[0].action[0].action[2].definition, "#CardiologyConsultationGoal")
        ...
        self.assertEqual(inst.action[0].action[1].action[1].action[0].definition, "#metoprololTartrate25Prescription")
        self.assertEqual(inst.action[0].action[1].action[1].action[0].dynamicValue[0].expression, "'draft'")
        self.assertEqual(inst.action[0].action[1].action[1].action[0].dynamicValue[0].path, "status")
        self.assertEqual(inst.action[0].action[1].action[1].action[0].dynamicValue[1].expression, "CardiologyChestPainLogic.Patient")
        self.assertEqual(inst.action[0].action[1].action[1].action[0].dynamicValue[1].path, "patient")
        self.assertEqual(inst.action[0].action[1].action[1].action[0].dynamicValue[2].expression, "CardiologyChestPainLogic.Practitioner")
        ...
        self.assertEqual(inst.action[0].action[1].action[1].action[1].definition, "#metoprololTartrate50Prescription")
        self.assertEqual(inst.action[0].action[1].action[1].action[1].dynamicValue[0].expression, "'draft'")
        self.assertEqual(inst.action[0].action[1].action[1].action[1].dynamicValue[0].path, "status")
        self.assertEqual(inst.action[0].action[1].action[1].action[1].dynamicValue[1].expression, "CardiologyChestPainLogic.Patient")
        self.assertEqual(inst.action[0].action[1].action[1].action[1].dynamicValue[1].path, "patient")
        self.assertEqual(inst.action[0].action[1].action[1].action[1].dynamicValue[2].expression, "CardiologyChestPainLogic.Practitioner")
        ...
        self.assertEqual(inst.action[0].action[1].action[1].action[2].definition, "#amlodipinePrescription")
        self.assertEqual(inst.action[0].action[1].action[1].action[2].dynamicValue[0].expression, "'draft'")
        self.assertEqual(inst.action[0].action[1].action[1].action[2].dynamicValue[0].path, "status")
        self.assertEqual(inst.action[0].action[1].action[1].action[2].dynamicValue[1].expression, "CardiologyChestPainLogic.Patient")
        self.assertEqual(inst.action[0].action[1].action[1].action[2].dynamicValue[1].path, "patient")
        self.assertEqual(inst.action[0].action[1].action[1].action[2].dynamicValue[2].expression, "CardiologyChestPainLogic.Practitioner")
        ...
        self.assertEqual(inst.action[0].action[1].action[2].action[0].definition, "#nitroglycerinPrescription")
        self.assertEqual(inst.action[0].action[1].action[2].action[0].dynamicValue[0].expression, "'draft'")
        self.assertEqual(inst.action[0].action[1].action[2].action[0].dynamicValue[0].path, "status")
        self.assertEqual(inst.action[0].action[1].action[2].action[0].dynamicValue[1].expression, "CardiologyChestPainLogic.Patient")
        self.assertEqual(inst.action[0].action[1].action[2].action[0].dynamicValue[1].path, "patient")
        self.assertEqual(inst.action[0].action[1].action[2].action[0].dynamicValue[2].expression, "CardiologyChestPainLogic.Practitioner")
        ...
        self.assertEqual(inst.contributor[0].name, "Bruce Bray MD")
        self.assertEqual(inst.contributor[0].type, "author")
        self.assertEqual(inst.contributor[1].name, "Scott Wall MD")
        self.assertEqual(inst.contributor[1].type, "author")
        self.assertEqual(inst.contributor[2].name, "Aiden Abidov MD, PhD")
        self.assertEqual(inst.contributor[2].type, "author")
        ...
        self.assertEqual(inst.type.coding[0].system, "http://hl7.org/fhir/plan-definition-type")
    ...
    def implPlanDefinition2(self, inst):
        self.assertEqual(inst.action[0].action[0].action[0].action[0].action[0].definition, "#1111")
        ...
        self.assertEqual(inst.action[0].action[0].action[0].action[0].action[1].definition, "#2222")
    ...
    def implPlanDefinition3(self, inst):
        self.assertEqual(inst.action[0].action[0].action[0].definition, "#referralToMentalHealthCare")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[0].expression, "Now()")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[0].path, "timing.event")
        ...
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[1].path, "specialty")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[2].expression, "SuicideRiskLogic.ServiceRequestFulfillmentTime")
        self.assertEqual(inst.action[0].action[0].action[0].dynamicValue[2].path, "occurrenceDateTime")
        ...
        self.assertEqual(inst.action[0].action[0].selectionBehavior, "any")
        self.assertEqual(inst.action[0].action[0].title, "Consults and Referrals")
        self.assertEqual(inst.action[0].action[1].action[0].action[0].action[0].definition, "#citalopramPrescription")
    ...
    def implPlanDefinition4(self, inst):
        self.assertEqual(inst.action[0].action[0].definition, "#activitydefinition-medicationrequest-1")
        ...
        self.assertEqual(inst.action[0].action[1].definition, "#activitydefinition-medicationrequest-2")
    ...
    def implPlanDefinition5(self, inst):
        ...
        self.assertEqual(inst.action[0].action[0].definition, "ActivityDefinition/administer-zika-virus-exposure-assessment")
        ...
        self.assertEqual(inst.action[0].action[1].definition, "ActivityDefinition/order-serum-urine-rrt-pcr-test")
        ...
        self.assertEqual(inst.action[0].action[2].definition, "ActivityDefinition/order-serum-zika-dengue-virus-igm")
        ...
        self.assertEqual(inst.action[0].action[3].definition, "ActivityDefinition/consider-igm-antibody-testing")
        self.assertEqual(inst.action[0].action[4].action[0].definition, "ActivityDefinition/provide-mosquito-prevention-advice")
        self.assertEqual(inst.action[0].action[4].action[1].definition, "ActivityDefinition/provide-contraception-advice")
    ...
    def implPlanDefinition6(self, inst):
        ...
        self.assertEqual(inst.action[0].definition, "#procedure")
