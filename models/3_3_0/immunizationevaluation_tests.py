...
class ImmunizationEvaluationTests(unittest.TestCase):
    ...
    def implImmunizationEvaluation1(self, inst):
        ...
        self.assertEqual(inst.doseStatus.coding[0].system, "http://hl7.org/fhir/vaccination-protocol-dose-status")
        ...
        self.assertEqual(inst.doseStatusReason[0].coding[0].system, "http://hl7.org/fhir/vaccination-protocol-dose-status-reason")
        ...
        self.assertEqual(inst.targetDisease[0].coding[0].code, "1857005")
        self.assertEqual(inst.targetDisease[0].coding[0].system, "http://snomed.info/sct")
