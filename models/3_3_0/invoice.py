...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/Invoice) on 2018-05-12.
...
class InvoiceLineItem(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("chargeItem", "chargeItem", fhirreference.FHIRReference, False, None, True),
...
class InvoiceLineItemPriceComponent(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("amount", "amount", float, False, None, False),
            ("code", "code", codeableconcept.CodeableConcept, False, None, False),
            ("factor", "factor", money.Money, False, None, False),
