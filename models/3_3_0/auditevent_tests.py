...
class AuditEventTests(unittest.TestCase):
    ...
    def implAuditEvent1(self, inst):
        ...
        self.assertEqual(inst.agent[0].type.coding[0].system, "http://hl7.org/fhir/extra-security-role-type")
    ...
    def implAuditEvent3(self, inst):
        ...
        self.assertEqual(inst.agent[1].type.coding[0].system, "http://hl7.org/fhir/extra-security-role-type")
