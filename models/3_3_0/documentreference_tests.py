...
class DocumentReferenceTests(unittest.TestCase):
    ...
    def implDocumentReference1(self, inst):
        ...
        self.assertEqual(inst.agent[0].type.coding[0].display, "author (originator)")
        self.assertEqual(inst.agent[0].type.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.agent[1].type.coding[0].code, "AUT")
        self.assertEqual(inst.agent[1].type.coding[0].display, "author (originator)")
