...
class ObservationDefinitionTests(unittest.TestCase):
    ...
    def implObservationDefinition1(self, inst):
        self.assertEqual(inst.code.code, "15074-8")
        self.assertEqual(inst.code.display, "Glucose [Moles/volume] in Blood")
        self.assertEqual(inst.code.system, "http://loinc.org")
