...
class MediaTests(unittest.TestCase):
    ...
    def implMedia4(self, inst):
        ...
        self.assertEqual(inst.modality.coding[0].system, "http://hl7.org/fhir/media-modality")
        self.assertEqual(inst.status, "completed")
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(inst.type.coding[0].code, "image")
        self.assertEqual(inst.type.coding[0].display, "Image")
        self.assertEqual(inst.type.coding[0].system, "http://hl7.org/fhir/CodeSystem/media-category")
