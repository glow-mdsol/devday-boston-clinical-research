...
class FHIRElementFactory(object):
    ...
    def instantiate(cls, resource_type, jsondict):
        ...
        if "ContractTermAssetData" == resource_type:
            from . import contract
            return contract.ContractTermAssetData(jsondict)
        ...
        if "CoverageCopay" == resource_type:
            from . import coverage
            return coverage.CoverageCopay(jsondict)
        ...
        if "DeviceComponentProperty" == resource_type:
            from . import devicecomponent
            return devicecomponent.DeviceComponentProperty(jsondict)
        ...
        if "DocumentManifestAgent" == resource_type:
            from . import documentmanifest
            return documentmanifest.DocumentManifestAgent(jsondict)
        ...
        if "DocumentReferenceAgent" == resource_type:
            from . import documentreference
            return documentreference.DocumentReferenceAgent(jsondict)
        ...
        if "EligibilityRequestAuthorization" == resource_type:
            from . import eligibilityrequest
            return eligibilityrequest.EligibilityRequestAuthorization(jsondict)
        if "EligibilityRequestAuthorizationDiagnosis" == resource_type:
            from . import eligibilityrequest
            return eligibilityrequest.EligibilityRequestAuthorizationDiagnosis(jsondict)
        ...
        if "EligibilityResponseAuthorization" == resource_type:
            from . import eligibilityresponse
            return eligibilityresponse.EligibilityResponseAuthorization(jsondict)
        ...
        if "EntryDefinition" == resource_type:
            from . import entrydefinition
            return entrydefinition.EntryDefinition(jsondict)
        if "EntryDefinitionRelatedEntry" == resource_type:
            from . import entrydefinition
            return entrydefinition.EntryDefinitionRelatedEntry(jsondict)
        ...
        if "ExampleScenarioProcessStepAlternativeOption" == resource_type:
            from . import examplescenario
            return examplescenario.ExampleScenarioProcessStepAlternativeOption(jsondict)
        ...
        if "ImplementationGuideDefinitionPackage" == resource_type:
            from . import implementationguide
            return implementationguide.ImplementationGuideDefinitionPackage(jsondict)
        ...
        if "MedicinalProductAuthorizationProcedureApplication" == resource_type:
            from . import medicinalproductauthorization
            return medicinalproductauthorization.MedicinalProductAuthorizationProcedureApplication(jsondict)
        if "MedicinalProductClinicals" == resource_type:
            from . import medicinalproductclinicals
            return medicinalproductclinicals.MedicinalProductClinicals(jsondict)
        if "MedicinalProductClinicalsContraindication" == resource_type:
            from . import medicinalproductclinicals
            return medicinalproductclinicals.MedicinalProductClinicalsContraindication(jsondict)
        if "MedicinalProductClinicalsInteractions" == resource_type:
            from . import medicinalproductclinicals
            return medicinalproductclinicals.MedicinalProductClinicalsInteractions(jsondict)
        if "MedicinalProductClinicalsTherapeuticIndication" == resource_type:
            from . import medicinalproductclinicals
            return medicinalproductclinicals.MedicinalProductClinicalsTherapeuticIndication(jsondict)
        if "MedicinalProductClinicalsTherapeuticIndicationOtherTherapy" == resource_type:
            from . import medicinalproductclinicals
            return medicinalproductclinicals.MedicinalProductClinicalsTherapeuticIndicationOtherTherapy(jsondict)
        if "MedicinalProductClinicalsUndesirableEffects" == resource_type:
            from . import medicinalproductclinicals
            return medicinalproductclinicals.MedicinalProductClinicalsUndesirableEffects(jsondict)
        if "MedicinalProductClinicalsUndesirableEffectsPopulation" == resource_type:
            from . import medicinalproductclinicals
            return medicinalproductclinicals.MedicinalProductClinicalsUndesirableEffectsPopulation(jsondict)
        if "MedicinalProductDeviceSpec" == resource_type:
            from . import medicinalproductdevicespec
            return medicinalproductdevicespec.MedicinalProductDeviceSpec(jsondict)
        if "MedicinalProductDeviceSpecMaterial" == resource_type:
            from . import medicinalproductdevicespec
            return medicinalproductdevicespec.MedicinalProductDeviceSpecMaterial(jsondict)
        ...
        if "MedicinalProductPackagedPackageItemManufacturedItem" == resource_type:
            from . import medicinalproductpackaged
            return medicinalproductpackaged.MedicinalProductPackagedPackageItemManufacturedItem(jsondict)
        ...
        if "OccupationalData" == resource_type:
            from . import occupationaldata
            return occupationaldata.OccupationalData(jsondict)
        if "OccupationalDataEmploymentStatus" == resource_type:
            from . import occupationaldata
            return occupationaldata.OccupationalDataEmploymentStatus(jsondict)
        if "OccupationalDataPastOrPresentJob" == resource_type:
            from . import occupationaldata
            return occupationaldata.OccupationalDataPastOrPresentJob(jsondict)
        if "OccupationalDataPastOrPresentJobWorkSchedule" == resource_type:
            from . import occupationaldata
            return occupationaldata.OccupationalDataPastOrPresentJobWorkSchedule(jsondict)
        if "OccupationalDataUsualWork" == resource_type:
            from . import occupationaldata
            return occupationaldata.OccupationalDataUsualWork(jsondict)
        ...
        if "OrganizationRole" == resource_type:
            from . import organizationrole
            return organizationrole.OrganizationRole(jsondict)
        if "OrganizationRoleAvailableTime" == resource_type:
            from . import organizationrole
            return organizationrole.OrganizationRoleAvailableTime(jsondict)
        if "OrganizationRoleNotAvailable" == resource_type:
            from . import organizationrole
            return organizationrole.OrganizationRoleNotAvailable(jsondict)
        ...
        if "ProductPlan" == resource_type:
            from . import productplan
            return productplan.ProductPlan(jsondict)
        if "ProductPlanContact" == resource_type:
            from . import productplan
            return productplan.ProductPlanContact(jsondict)
        if "ProductPlanCoverage" == resource_type:
            from . import productplan
            return productplan.ProductPlanCoverage(jsondict)
        if "ProductPlanCoverageBenefit" == resource_type:
            from . import productplan
            return productplan.ProductPlanCoverageBenefit(jsondict)
        if "ProductPlanCoverageBenefitItem" == resource_type:
            from . import productplan
            return productplan.ProductPlanCoverageBenefitItem(jsondict)
        if "ProductPlanPlan" == resource_type:
            from . import productplan
            return productplan.ProductPlanPlan(jsondict)
        if "ProductPlanPlanCategory" == resource_type:
            from . import productplan
            return productplan.ProductPlanPlanCategory(jsondict)
        if "ProductPlanPlanCategoryBenefit" == resource_type:
            from . import productplan
            return productplan.ProductPlanPlanCategoryBenefit(jsondict)
        if "ProductPlanPlanCategoryBenefitCost" == resource_type:
            from . import productplan
            return productplan.ProductPlanPlanCategoryBenefitCost(jsondict)
        ...
        if "SequenceQualityRoc" == resource_type:
            from . import sequence
            return sequence.SequenceQualityRoc(jsondict)
        ...
        if "SpecimenDefinitionSpecimenToLab" == resource_type:
            from . import specimendefinition
            return specimendefinition.SpecimenDefinitionSpecimenToLab(jsondict)
        if "SpecimenDefinitionSpecimenToLabContainerAdditive" == resource_type:
            from . import specimendefinition
            return specimendefinition.SpecimenDefinitionSpecimenToLabContainerAdditive(jsondict)
        if "SpecimenDefinitionSpecimenToLabHandling" == resource_type:
            from . import specimendefinition
            return specimendefinition.SpecimenDefinitionSpecimenToLabHandling(jsondict)
        ...
        if "SubstanceMoiety" == resource_type:
            from . import substancemoiety
            return substancemoiety.SubstanceMoiety(jsondict)
        ...
        if "SubstanceReferenceInformationRelationship" == resource_type:
            from . import substancereferenceinformation
            return substancereferenceinformation.SubstanceReferenceInformationRelationship(jsondict)
        ...
        if "SubstanceSpecificationStructureStructuralRepresentation" == resource_type:
            from . import substancespecification
            return substancespecification.SubstanceSpecificationStructureStructuralRepresentation(jsondict)
        if "SubstanceSpecificationSubstanceCode" == resource_type:
            from . import substancespecification
            return substancespecification.SubstanceSpecificationSubstanceCode(jsondict)
        if "SubstanceSpecificationSubstanceName" == resource_type:
            from . import substancespecification
            return substancespecification.SubstanceSpecificationSubstanceName(jsondict)
        if "SubstanceSpecificationSubstanceNameOfficialName" == resource_type:
            from . import substancespecification
            return substancespecification.SubstanceSpecificationSubstanceNameOfficialName(jsondict)
        ...
        if "TriggerDefinitionCondition" == resource_type:
            from . import triggerdefinition
            return triggerdefinition.TriggerDefinitionCondition(jsondict)
        if "UsageContext" == resource_type:
            from . import usagecontext
            return usagecontext.UsageContext(jsondict)
        if "UserSession" == resource_type:
            from . import usersession
            return usersession.UserSession(jsondict)
        if "UserSessionContext" == resource_type:
            from . import usersession
            return usersession.UserSessionContext(jsondict)
        if "UserSessionStatus" == resource_type:
            from . import usersession
            return usersession.UserSessionStatus(jsondict)
        ...
        if "VisionPrescriptionDispensePrism" == resource_type:
            from . import visionprescription
            return visionprescription.VisionPrescriptionDispensePrism(jsondict)
        from . import element
        return element.Element(jsondict)
