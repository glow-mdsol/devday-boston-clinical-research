...
class ClaimResponseTests(unittest.TestCase):
    ...
    def implClaimResponse2(self, inst):
        self.assertEqual(inst.addItem[0].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.addItem[0].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.addItem[0].adjudication[1].amount.code, "USD")
        self.assertEqual(inst.addItem[0].adjudication[1].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.addItem[0].adjudication[3].amount.code, "USD")
        self.assertEqual(inst.addItem[0].adjudication[3].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.addItem[0].adjudication[3].reason.coding[0].system, "http://hl7.org/fhir/adjudication-reason")
        self.assertEqual(inst.addItem[0].fee.code, "USD")
        self.assertEqual(inst.addItem[0].fee.system, "urn:iso:std:iso:4217")
        self.assertEqual(inst.addItem[0].fee.value, 135.57)
        ...
        self.assertEqual(inst.addItem[0].service.coding[0].code, "1101")
        self.assertEqual(inst.addItem[0].service.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.addItem[1].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.addItem[1].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.addItem[1].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.addItem[1].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.addItem[1].fee.code, "USD")
        self.assertEqual(inst.addItem[1].fee.system, "urn:iso:std:iso:4217")
        self.assertEqual(inst.addItem[1].fee.value, 35.57)
        self.assertEqual(inst.addItem[1].itemSequence[0], 1)
        self.assertEqual(inst.addItem[1].service.coding[0].code, "2141")
        self.assertEqual(inst.addItem[1].service.coding[0].display, "Radiograph, bytewing")
        self.assertEqual(inst.addItem[1].service.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.addItem[2].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.addItem[2].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.addItem[2].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.addItem[2].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.addItem[2].fee.code, "USD")
        self.assertEqual(inst.addItem[2].fee.system, "urn:iso:std:iso:4217")
        self.assertEqual(inst.addItem[2].fee.value, 350.0)
        ...
        self.assertEqual(inst.addItem[2].service.coding[0].code, "expense")
        self.assertEqual(inst.addItem[2].service.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.created.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.created.as_json(), "2014-08-16")
        ...
        self.assertEqual(inst.item[0].itemSequence, 1)
        self.assertEqual(inst.item[1].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[1].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[1].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.item[1].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[1].itemSequence, 2)
        self.assertEqual(inst.item[2].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[2].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[2].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.item[2].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[2].detail[0].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[2].detail[0].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[2].detail[0].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.item[2].detail[0].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[2].detail[0].detailSequence, 1)
        self.assertEqual(inst.item[2].detail[1].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[2].detail[1].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[2].detail[1].adjudication[1].amount.code, "USD")
        self.assertEqual(inst.item[2].detail[1].adjudication[1].amount.system, "urn:iso:std:iso:4217")
    ...
    def implClaimResponse3(self, inst):
        ...
        self.assertEqual(inst.item[0].detail[0].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[0].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[0].adjudication[1].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[0].adjudication[1].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[0].adjudication[3].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[0].adjudication[3].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[1].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[1].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[1].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[1].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[0].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[1].subDetail[0].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[0].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[1].subDetail[0].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[1].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[1].subDetail[1].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[1].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[1].subDetail[1].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[2].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[1].subDetail[2].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[2].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[1].subDetail[2].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[2].adjudication[0].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[2].adjudication[0].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.item[0].detail[2].adjudication[2].amount.code, "USD")
        self.assertEqual(inst.item[0].detail[2].adjudication[2].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.payeeType.coding[0].code, "provider")
        self.assertEqual(inst.payeeType.coding[0].system, "http://hl7.org/fhir/payeetype")
        self.assertEqual(inst.payment.adjustment.code, "USD")
        self.assertEqual(inst.payment.adjustment.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.payment.adjustmentReason.coding[0].system, "http://hl7.org/fhir/payment-adjustment-reason")
        self.assertEqual(inst.payment.amount.code, "USD")
        self.assertEqual(inst.payment.amount.system, "urn:iso:std:iso:4217")
    ...
    def implClaimResponse4(self, inst):
        ...
        self.assertEqual(inst.item[0].adjudication[3].reason.coding[0].system, "http://hl7.org/fhir/adjudication-reason")
        self.assertEqual(inst.item[0].itemSequence, 1)
        self.assertEqual(inst.outcome, "complete")
        self.assertEqual(inst.payeeType.coding[0].code, "provider")
        self.assertEqual(inst.payeeType.coding[0].system, "http://hl7.org/fhir/payeetype")
