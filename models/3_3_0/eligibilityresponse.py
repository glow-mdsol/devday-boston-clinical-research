...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/EligibilityResponse) on 2018-05-12.
...
class EligibilityResponse(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        List of `EligibilityResponseAuthorization` items (represented as `dict` in JSON). """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("authorization", "authorization", EligibilityResponseAuthorization, True, None, False),
...
class EligibilityResponseAuthorization(backboneelement.BackboneElement):
    """ Services which may require prior authorization.
    ...
    resource_type = "EligibilityResponseAuthorization"
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.authorizationSequence = None
        ...
        super(EligibilityResponseAuthorization, self).__init__(jsondict=jsondict, strict=strict)
    
    def elementProperties(self):
        js = super(EligibilityResponseAuthorization, self).elementProperties()
        js.extend([
            ("authorizationSequence", "authorizationSequence", int, False, None, True),
