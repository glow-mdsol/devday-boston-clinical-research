...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/OperationDefinition) on 2018-05-12.
...
class OperationDefinitionParameterBinding(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("valueSetCanonical", "valueSetCanonical", str, False, "valueSet", True),
