...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim1(self, inst):
        ...
        self.assertEqual(inst.item[0].service.coding[0].code, "62264")
        self.assertEqual(inst.item[0].service.coding[0].display, "Surgical Procedures on the Spine and Spinal Cord")
        self.assertEqual(inst.item[0].service.coding[0].system, "http://www.ama-assn.org/go/cpt")
        ...
        self.assertEqual(inst.subType[0].coding[0].code, "831")
        self.assertEqual(inst.subType[0].coding[0].system, "https://www.cms.gov/codes/billtype")
    ...
    def implClaim5(self, inst):
        ...
        self.assertEqual(inst.item[2].unitPrice.system, "urn:iso:std:iso:4217")
        self.assertEqual(inst.item[2].unitPrice.value, 1100.0)
        self.assertEqual(inst.payee.resource.code, "relatedperson")
