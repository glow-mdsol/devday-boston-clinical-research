...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/ElementDefinition) on 2018-05-12.
...
class ElementDefinitionType(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ Profile (StructureDefinition or IG) on the Reference target - one
        must apply.
        List of `str` items. """
