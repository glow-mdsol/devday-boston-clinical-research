...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/SubstanceReferenceInformation) on 2018-05-12.
...
class SubstanceReferenceInformation(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ Todo.
        List of `SubstanceReferenceInformationRelationship` items (represented as `dict` in JSON). """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("relationship", "relationship", SubstanceReferenceInformationRelationship, True, None, False),
...
class SubstanceReferenceInformationRelationship(backboneelement.BackboneElement):
    """ Todo.
    """
    
    resource_type = "SubstanceReferenceInformationRelationship"
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(SubstanceReferenceInformationRelationship, self).__init__(jsondict=jsondict, strict=strict)
    
    def elementProperties(self):
        js = super(SubstanceReferenceInformationRelationship, self).elementProperties()
        js.extend([
