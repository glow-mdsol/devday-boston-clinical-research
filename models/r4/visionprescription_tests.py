...
class VisionPrescriptionTests(unittest.TestCase):
    ...
    def implVisionPrescription2(self, inst):
        ...
        self.assertEqual(inst.dispense[0].eye, "right")
        self.assertEqual(inst.dispense[0].prism[0].amount, 0.5)
        self.assertEqual(inst.dispense[0].prism[0].base, "down")
        ...
        self.assertEqual(inst.dispense[1].eye, "left")
        self.assertEqual(inst.dispense[1].prism[0].amount, 0.5)
        self.assertEqual(inst.dispense[1].prism[0].base, "up")
