...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/Task) on 2018-05-12.
...
class Task(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.instantiatesReference = None
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("instantiatesReference", "instantiatesReference", fhirreference.FHIRReference, False, "instantiates", False),
            ("instantiatesUri", "instantiatesUri", str, False, "instantiates", False),
