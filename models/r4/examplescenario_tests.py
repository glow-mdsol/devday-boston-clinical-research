...
class ExampleScenarioTests(unittest.TestCase):
    ...
    def implExampleScenario1(self, inst):
        ...
        self.assertEqual(inst.process[0].step[7].alternative.name, "Check if patient took drugs")
        self.assertEqual(inst.process[0].step[7].alternative.option[0].description, "Yes, patient took drugs")
        self.assertEqual(inst.process[0].step[7].alternative.option[0].step[0].process[0].step[0].operation.initiator, "Nurse")
        self.assertTrue(inst.process[0].step[7].alternative.option[0].step[0].process[0].step[0].operation.initiatorActive)
        self.assertEqual(inst.process[0].step[7].alternative.option[0].step[0].process[0].step[0].operation.name, "Register Meds taken")
        self.assertEqual(inst.process[0].step[7].alternative.option[0].step[0].process[0].step[0].operation.number, "1a")
        self.assertEqual(inst.process[0].step[7].alternative.option[0].step[0].process[0].step[0].operation.receiver, "MAP")
        self.assertEqual(inst.process[0].step[7].alternative.option[0].step[0].process[0].title, "Register Meds taken")
        self.assertEqual(inst.process[0].step[7].alternative.option[1].description, "No, patient did not take drugs")
        self.assertEqual(inst.process[0].step[7].alternative.option[1].step[0].process[0].step[0].operation.initiator, "Nurse")
        self.assertTrue(inst.process[0].step[7].alternative.option[1].step[0].process[0].step[0].operation.initiatorActive)
        self.assertEqual(inst.process[0].step[7].alternative.option[1].step[0].process[0].step[0].operation.name, "Register Meds NOT taken")
        self.assertEqual(inst.process[0].step[7].alternative.option[1].step[0].process[0].step[0].operation.number, "1b")
        self.assertEqual(inst.process[0].step[7].alternative.option[1].step[0].process[0].step[0].operation.receiver, "MAP")
        self.assertEqual(inst.process[0].step[7].alternative.option[1].step[0].process[0].title, "Register Meds NOT taken")
        self.assertEqual(inst.process[0].step[7].alternative.option[2].description, "Not clear")
        self.assertTrue(inst.process[0].step[7].alternative.option[2].step[0].pause)
