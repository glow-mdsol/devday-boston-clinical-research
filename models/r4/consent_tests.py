...
class ConsentTests(unittest.TestCase):
    ...
    def implConsent1(self, inst):
        ...
        self.assertEqual(inst.category[0].coding[0].system, "http://hl7.org/fhir/v3/ActCode")
        ...
        self.assertEqual(inst.policyRule.coding[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.actor[0].role.coding[0].code, "CST")
        self.assertEqual(inst.provision.actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[0].actor[0].role.coding[0].code, "CST")
        self.assertEqual(inst.provision.provision[0].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[0].type, "deny")
        self.assertEqual(inst.provision.purpose[0].code, "ETREAT")
        self.assertEqual(inst.provision.purpose[0].system, "http://hl7.org/fhir/v3/ActReason")
        self.assertEqual(inst.scope.coding[0].code, "patient-privacy")
        self.assertEqual(inst.scope.coding[0].system, "http://hl7.org/fhir/consentscope")
    ...
    def implConsent2(self, inst):
        ...
        self.assertEqual(inst.provision.action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.actor[0].role.coding[0].code, "CST")
        self.assertEqual(inst.provision.actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.actor[1].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.actor[1].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.scope.coding[0].code, "patient-privacy")
        self.assertEqual(inst.scope.coding[0].system, "http://hl7.org/fhir/consentscope")
        self.assertEqual(inst.sourceAttachment.title, "The terms of the consent in lawyer speak.")
        self.assertEqual(inst.status, "in-progress")
    ...
    def implConsent4(self, inst):
        ...
        self.assertEqual(inst.provision.action[1].coding[0].system, "http://hl7.org/fhir/consentaction")
    ...
    def implConsent9(self, inst):
        ...
        self.assertEqual(inst.provision.provision[0].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        ...
        self.assertEqual(inst.provision.provision[0].securityLabel[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.provision[1].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[1].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[1].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[1].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[1].securityLabel[0].code, "SPI")
        self.assertEqual(inst.provision.provision[1].securityLabel[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.provision[2].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[2].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[2].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[2].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[2].securityLabel[0].code, "N")
        self.assertEqual(inst.provision.provision[2].securityLabel[0].system, "http://hl7.org/fhir/v3/Confidentiality")
        self.assertEqual(inst.provision.provision[3].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[3].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[3].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[3].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[3].securityLabel[0].code, "PSY")
        self.assertEqual(inst.provision.provision[3].securityLabel[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.provision[4].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[4].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[4].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[4].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[4].securityLabel[0].code, "SPI")
        self.assertEqual(inst.provision.provision[4].securityLabel[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.provision[5].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[5].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[5].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[5].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[5].securityLabel[0].code, "SEX")
        self.assertEqual(inst.provision.provision[5].securityLabel[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.provision[6].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[6].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[6].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[6].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[6].securityLabel[0].code, "N")
        self.assertEqual(inst.provision.provision[6].securityLabel[0].system, "http://hl7.org/fhir/v3/Confidentiality")
        self.assertEqual(inst.provision.provision[7].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[7].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[7].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[7].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[7].securityLabel[0].code, "PSY")
        self.assertEqual(inst.provision.provision[7].securityLabel[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.provision[8].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[8].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[8].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[8].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[8].securityLabel[0].code, "SPI")
        self.assertEqual(inst.provision.provision[8].securityLabel[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.provision[9].action[0].coding[0].code, "access")
        self.assertEqual(inst.provision.provision[9].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.provision.provision[9].actor[0].role.coding[0].code, "PRCP")
        self.assertEqual(inst.provision.provision[9].actor[0].role.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.provision.provision[9].securityLabel[0].code, "SEX")
        self.assertEqual(inst.provision.provision[9].securityLabel[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.provision.securityLabel[0].code, "N")
        self.assertEqual(inst.provision.securityLabel[0].system, "http://hl7.org/fhir/v3/Confidentiality")
        self.assertEqual(inst.scope.coding[0].code, "patient-privacy")
        self.assertEqual(inst.scope.coding[0].system, "http://hl7.org/fhir/consentscope")
        self.assertEqual(inst.status, "in-progress")
        self.assertEqual(inst.text.status, "generated")
