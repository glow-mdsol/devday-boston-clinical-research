...
class ExplanationOfBenefitTests(unittest.TestCase):
    ...
    def implExplanationOfBenefit1(self, inst):
        ...
        self.assertEqual(inst.accident.type.coding[0].system, "http://hl7.org/fhir/v3/ActCode")
        ...
        self.assertEqual(inst.form.coding[0].system, "http://hl7.org/fhir/forms-codes")
        ...
        self.assertEqual(inst.information[1].category.coding[0].system, "http://hl7.org/fhir/ValueSet/claiminformationcategory")
        ...
        self.assertEqual(inst.total[0].amount.code, "USD")
        self.assertEqual(inst.total[0].amount.system, "urn:iso:std:iso:4217")
        self.assertEqual(inst.total[0].amount.value, 2478.57)
        self.assertEqual(inst.total[0].category.coding[0].code, "submitted")
        self.assertEqual(inst.total[1].amount.code, "USD")
        self.assertEqual(inst.total[1].amount.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.type.coding[0].system, "http://hl7.org/fhir/claim-type")
    ...
    def implExplanationOfBenefit2(self, inst):
        ...
        self.assertEqual(inst.payee.resource.system, "http://hl7.org/fhir/resource-type-link")
