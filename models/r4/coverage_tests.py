...
class CoverageTests(unittest.TestCase):
    ...
    def implCoverage1(self, inst):
        ...
        self.assertEqual(inst.class_fhir[0].type.code, "group")
        self.assertEqual(inst.class_fhir[0].type.system, "http://hl7.org/fhir/coverage-class")
        ...
        self.assertEqual(inst.class_fhir[1].type.code, "plan")
        self.assertEqual(inst.class_fhir[1].type.system, "http://hl7.org/fhir/coverage-class")
        self.assertEqual(inst.class_fhir[1].value, "BG4352")
        self.assertEqual(inst.class_fhir[2].name, "Platinum")
        self.assertEqual(inst.class_fhir[2].type.code, "subplan")
        self.assertEqual(inst.class_fhir[2].type.system, "http://hl7.org/fhir/coverage-class")
    ...
    def implCoverage4(self, inst):
        ...
        self.assertEqual(inst.class_fhir[0].type.code, "group")
        self.assertEqual(inst.class_fhir[0].type.system, "http://hl7.org/fhir/coverage-level")
        self.assertEqual(inst.class_fhir[0].value, "CB135")
        self.assertEqual(inst.class_fhir[1].name, "Trainee Part-time Benefits")
        self.assertEqual(inst.class_fhir[1].type.code, "subgroup")
        self.assertEqual(inst.class_fhir[1].type.system, "http://hl7.org/fhir/coverage-level")
        ...
        self.assertEqual(inst.class_fhir[2].type.code, "plan")
        self.assertEqual(inst.class_fhir[2].type.system, "http://hl7.org/fhir/coverage-level")
        self.assertEqual(inst.class_fhir[2].value, "B37FC")
        self.assertEqual(inst.class_fhir[3].name, "Includes afterlife benefits")
        self.assertEqual(inst.class_fhir[3].type.code, "subplan")
        self.assertEqual(inst.class_fhir[3].type.system, "http://hl7.org/fhir/coverage-level")
        self.assertEqual(inst.class_fhir[3].value, "P7")
        self.assertEqual(inst.class_fhir[4].name, "Silver: Family Plan spouse only")
        self.assertEqual(inst.class_fhir[4].type.code, "class")
        self.assertEqual(inst.class_fhir[4].type.system, "http://hl7.org/fhir/coverage-level")
        self.assertEqual(inst.class_fhir[4].value, "SILVER")
        self.assertEqual(inst.class_fhir[5].name, "Low deductable, max $20 copay")
        self.assertEqual(inst.class_fhir[5].type.code, "subclass")
        self.assertEqual(inst.class_fhir[5].type.system, "http://hl7.org/fhir/coverage-level")
        self.assertEqual(inst.class_fhir[5].value, "Tier2")
        self.assertEqual(inst.class_fhir[6].type.code, "sequence")
        self.assertEqual(inst.class_fhir[6].type.system, "http://hl7.org/fhir/coverage-level")
        self.assertEqual(inst.class_fhir[6].value, "9")
        self.assertEqual(inst.class_fhir[7].type.code, "rxid")
        self.assertEqual(inst.class_fhir[7].type.system, "http://hl7.org/fhir/coverage-level")
        self.assertEqual(inst.class_fhir[7].value, "MDF12345")
        self.assertEqual(inst.class_fhir[8].type.code, "rxbin")
        self.assertEqual(inst.class_fhir[8].type.system, "http://hl7.org/fhir/coverage-level")
        self.assertEqual(inst.class_fhir[8].value, "987654")
        self.assertEqual(inst.class_fhir[9].type.code, "rxgroup")
        self.assertEqual(inst.class_fhir[9].type.system, "http://hl7.org/fhir/coverage-level")
