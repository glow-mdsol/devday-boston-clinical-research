...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/DocumentManifest) on 2018-05-12.
...
class DocumentManifest(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.agent = None
        """ Agent involved.
        List of `DocumentManifestAgent` items (represented as `dict` in JSON). """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("agent", "agent", DocumentManifestAgent, True, None, False),
...
class DocumentManifestAgent(backboneelement.BackboneElement):
    """ Agent involved.
    
    An actor taking an active role in the manifest.
    """
    
    resource_type = "DocumentManifestAgent"
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(DocumentManifestAgent, self).__init__(jsondict=jsondict, strict=strict)
    
    def elementProperties(self):
        js = super(DocumentManifestAgent, self).elementProperties()
        js.extend([
            ("type", "type", codeableconcept.CodeableConcept, False, None, False),
