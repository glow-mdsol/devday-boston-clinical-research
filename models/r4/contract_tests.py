...
class ContractTests(unittest.TestCase):
    ...
    def implContract1(self, inst):
        ...
        self.assertEqual(inst.contentDerivative.coding[0].system, "http://hl7.org/fhir/contract-content-derivative")
        ...
        self.assertEqual(inst.term[0].actionReason[0].coding[0].code, "HPRGRP")
        self.assertEqual(inst.term[0].actionReason[0].coding[0].system, "http://hl7.org/fhir/v3/ActReason")
        self.assertEqual(inst.term[0].action[0].coding[0].code, "action-a")
        self.assertEqual(inst.term[0].action[0].coding[0].system, "http://www.hl7.org/fhir/contractaction")
        self.assertEqual(inst.term[0].agent[0].role[0].coding[0].code, "IR")
        self.assertEqual(inst.term[0].agent[0].role[0].coding[0].display, "Recipient")
        self.assertEqual(inst.term[0].agent[0].role[0].coding[0].system, "http://org.mdhhs.fhir.consent-actor-type")
        self.assertEqual(inst.term[0].agent[0].role[0].text, "Recipient of restricted health information")
        self.assertEqual(inst.term[0].agent[1].role[0].coding[0].code, "IS")
        self.assertEqual(inst.term[0].agent[1].role[0].coding[0].display, "Sender")
        self.assertEqual(inst.term[0].agent[1].role[0].coding[0].system, "http://org.mdhhs.fhir.consent-actor-type")
        self.assertEqual(inst.term[0].agent[1].role[0].text, "Sender of restricted health information")
        self.assertEqual(inst.term[0].asset[0].dataPeriod.end.date, FHIRDate("2019-11-01T21:18:27-04:00").date)
        self.assertEqual(inst.term[0].asset[0].dataPeriod.end.as_json(), "2019-11-01T21:18:27-04:00")
        self.assertEqual(inst.term[0].asset[0].dataPeriod.start.date, FHIRDate("2013-11-01T21:18:27-04:00").date)
        self.assertEqual(inst.term[0].asset[0].dataPeriod.start.as_json(), "2013-11-01T21:18:27-04:00")
        self.assertEqual(inst.term[0].asset[0].data[0].meaning, "instance")
        self.assertEqual(inst.term[0].asset[0].securityLabel[0].code, "R")
        self.assertEqual(inst.term[0].asset[0].securityLabel[0].display, "Restricted")
        self.assertEqual(inst.term[0].asset[0].securityLabel[0].system, "http://hl7.org/fhir/v3/Confidentiality")
        self.assertEqual(inst.term[0].asset[0].securityLabel[1].code, "ETH")
        self.assertEqual(inst.term[0].asset[0].securityLabel[1].display, "substance abuse information sensitivity")
        self.assertEqual(inst.term[0].asset[0].securityLabel[1].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.term[0].asset[0].securityLabel[2].code, "42CFRPart2")
        self.assertEqual(inst.term[0].asset[0].securityLabel[2].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.term[0].asset[0].securityLabel[3].code, "TREAT")
        self.assertEqual(inst.term[0].asset[0].securityLabel[3].display, "treatment")
        self.assertEqual(inst.term[0].asset[0].securityLabel[3].system, "http://hl7.org/fhir/v3/ActReason")
        self.assertEqual(inst.term[0].asset[0].securityLabel[4].code, "HPAYMT")
        self.assertEqual(inst.term[0].asset[0].securityLabel[4].display, "healthcare payment")
        self.assertEqual(inst.term[0].asset[0].securityLabel[4].system, "http://hl7.org/fhir/v3/ActReason")
        self.assertEqual(inst.term[0].asset[0].securityLabel[5].code, "HOPERAT")
        self.assertEqual(inst.term[0].asset[0].securityLabel[5].display, "healthcare operations")
        self.assertEqual(inst.term[0].asset[0].securityLabel[5].system, "http://hl7.org/fhir/v3/ActReason")
        self.assertEqual(inst.term[0].asset[0].securityLabel[6].code, "PERSISTLABEL")
        self.assertEqual(inst.term[0].asset[0].securityLabel[6].display, "persist security label")
        self.assertEqual(inst.term[0].asset[0].securityLabel[6].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.term[0].asset[0].securityLabel[7].code, "PRIVMARK")
        self.assertEqual(inst.term[0].asset[0].securityLabel[7].display, "privacy mark")
        self.assertEqual(inst.term[0].asset[0].securityLabel[7].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.term[0].asset[0].securityLabel[8].code, "NORDSCLCD")
        self.assertEqual(inst.term[0].asset[0].securityLabel[8].display, "no redisclosure without consent directive")
        self.assertEqual(inst.term[0].asset[0].securityLabel[8].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.term[0].offer.decision.coding[0].code, "OPTIN")
        self.assertEqual(inst.term[0].offer.decision.coding[0].system, "http://hl7.org/fhir/v3/ActCode")
        self.assertEqual(inst.term[0].offer.text, "Can't refuse")
        self.assertEqual(inst.term[0].offer.type.coding[0].code, "statutory")
        self.assertEqual(inst.term[0].offer.type.coding[0].system, "http://hl7.org/fhir/contract-term-type")
    ...
    def implContract2(self, inst):
        ...
        self.assertEqual(inst.term[0].asset[0].class_fhir.code, "RicardianContract")
        self.assertEqual(inst.term[0].asset[0].class_fhir.system, "urn:ietf:rfc:3986")
        self.assertEqual(inst.term[0].asset[0].code.display, "sample")
        self.assertEqual(inst.term[0].asset[0].period.start.date, FHIRDate("2017-06-01").date)
        self.assertEqual(inst.term[0].asset[0].period.start.as_json(), "2017-06-01")
        ...
        self.assertEqual(inst.term[0].asset[0].valuedItem[0].net.code, "CAD")
        self.assertEqual(inst.term[0].asset[0].valuedItem[0].net.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.term[0].asset[0].valuedItem[0].unitPrice.code, "CAD")
        self.assertEqual(inst.term[0].asset[0].valuedItem[0].unitPrice.system, "urn:iso:std:iso:4217")
        ...
        self.assertEqual(inst.type.coding[0].system, "http://hl7.org/fhir/contracttypecodes")
    ...
    def implContract3(self, inst):
        ...
        self.assertEqual(inst.rule.contentAttachment.contentType, "application/txt")
        self.assertEqual(inst.rule.contentAttachment.url, "http://www.rfc-editor.org/bcp/bcp13.txt")
        self.assertEqual(inst.term[0].asset[0].class_fhir.code, "RicardianContract")
        self.assertEqual(inst.term[0].asset[0].class_fhir.system, "urn:ietf:rfc:3986")
        self.assertEqual(inst.term[0].asset[0].code.display, "sample")
        self.assertEqual(inst.term[0].asset[0].period.start.date, FHIRDate("2017-06-01").date)
