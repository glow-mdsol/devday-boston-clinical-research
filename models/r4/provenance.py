...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/Provenance) on 2018-05-12.
...
class ProvenanceAgent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.onBehalfOfIdentifier = None
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("onBehalfOfIdentifier", "onBehalfOfIdentifier", identifier.Identifier, False, "onBehalfOf", False),
            ...
            ("whoIdentifier", "whoIdentifier", identifier.Identifier, False, "who", True),
