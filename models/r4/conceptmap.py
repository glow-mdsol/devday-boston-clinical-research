...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/ConceptMap) on 2018-05-12.
...
class ConceptMapGroup(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.unmapped = None
        """ When there is no match for the source concept in the target system,
        so no mapping is available.
...
class ConceptMapGroupUnmapped(backboneelement.BackboneElement):
    """ When there is no match for the source concept in the target system, so no
    mapping is available.
    
    What to do when there is no match for the source concept in the target
    system designated for the group and no mapping is able to be made.
    """
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.url = None
        """ Canonical URI for an additional ConceptMap to use for mapping if
