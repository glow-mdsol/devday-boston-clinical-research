...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/ValueSet) on 2018-05-12.
...
class ValueSet(domainresource.DomainResource):
    ...
    A ValueSet resource specifies a set of codes drawn from one or more code
