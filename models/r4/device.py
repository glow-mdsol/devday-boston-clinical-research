...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/Device) on 2018-05-12.
...
class DeviceUdi(backboneelement.BackboneElement):
    ...
    [Unique device identifier (UDI)](device.html#udi) assigned to device label
    or package.
    """
