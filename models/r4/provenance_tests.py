...
class ProvenanceTests(unittest.TestCase):
    ...
    def implProvenance1(self, inst):
        ...
        self.assertEqual(inst.agent[0].type.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
    ...
    def implProvenance3(self, inst):
        ...
        self.assertEqual(inst.agent[0].type.coding[0].system, "http://www.hl7.org/fhir/contractsignertypecodes")
        self.assertEqual(inst.agent[0].whoIdentifier.system, "urn:ietf:rfc:3986")
        self.assertEqual(inst.agent[0].whoIdentifier.value, "mailto://hhd@ssa.gov")
    ...
    def implProvenance4(self, inst):
        ...
        self.assertEqual(inst.agent[1].type.coding[0].system, "http://hl7.org/fhir/v3/ParticipationType")
        self.assertEqual(inst.entity[0].role, "source")
