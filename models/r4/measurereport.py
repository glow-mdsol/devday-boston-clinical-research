...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/MeasureReport) on 2018-05-12.
...
class MeasureReportGroupPopulation(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("subjects", "subjects", fhirreference.FHIRReference, False, None, False),
        ])
        return js
