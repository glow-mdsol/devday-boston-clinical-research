...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.3.0 (http://hl7.org/fhir/StructureDefinition/MessageDefinition) on 2018-05-12.
...
class MessageDefinition(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.url = None
        """ Canonical identifier for this message definition, represented as a
        URI (globally unique).
        Type `str`. """
