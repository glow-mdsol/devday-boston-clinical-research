...
class RelatedPersonTests(unittest.TestCase):
    ...
    def implRelatedPerson1(self, inst):
        ...
        self.assertEqual(inst.relationship[0].coding[0].system, "http://hl7.org/fhir/v3/RoleCode")
    ...
    def implRelatedPerson4(self, inst):
        ...
        self.assertEqual(inst.relationship[0].coding[0].system, "http://hl7.org/fhir/v2/0131")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
    ...
    def implRelatedPerson5(self, inst):
        ...
        self.assertEqual(inst.relationship[0].coding[1].system, "http://hl7.org/fhir/v3/RoleCode")
        self.assertEqual(inst.telecom[0].system, "phone")
