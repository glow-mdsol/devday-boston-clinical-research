...
class ImplementationGuideTests(unittest.TestCase):
    ...
    def implImplementationGuide1(self, inst):
        ...
        self.assertEqual(inst.definition.package[0].description, "Base package (not broken up into multiple packages)")
        self.assertEqual(inst.definition.package[0].name, "test")
        ...
        self.assertEqual(inst.definition.parameter[0].code, "apply-business-version")
        self.assertEqual(inst.definition.parameter[0].value, "1.0")
        self.assertEqual(inst.definition.resource[0].description, "A test example to show how a implementation guide works")
