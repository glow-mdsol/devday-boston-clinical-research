...
from exercises.population.ehr_to_rave_odm import make_odm, audit_id

__author__ = 'glow'

RAVE_URL = "https://innovate.mdsol.com"
RAVE_USER = os.getenv('RAVE_USER')
RAVE_PASSWORD = os.getenv('RAVE_PASSWORD')
STUDY = "EHRtoEDC"
ENV = "Prod"
...
def get_rave_subjects():
    ...
    subjects = client.send_request(StudySubjectsRequest(STUDY,
                                                        ENV,
        ...
        if resource.get('dosage'):
            ...
            if dosage.get('route'):
                mapping.append(dict(folder_oid="SUBJECT",
                                    ...
                                    cdash_domain="CM",
                                    log_context_field="CM.CMINDC", log_context_value=ctxt))
        odm = make_odm(STUDY, ENV, locationoid, subject_uuid, mapping,
